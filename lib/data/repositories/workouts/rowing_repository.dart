      ...
      if (weekNum == 1) {
        days = [
          PlanDay(
            ...
            workout: simpleIntervalWorkout('2 min row, 2 min rest', 'Row comfortably at 18-22 SPM. Focus on technique.', workDuration: const Duration(minutes: 2), restDuration: const Duration(minutes: 2), reps: 4),
          ),
          PlanDay(
            id: 'ii_beg_w1_d2',
            title: 'Session 2: Endurance',
            workout: simpleIntervalWorkout('5 min row, 3 min rest', 'Hold a conversation pace. 18-22 SPM.', workDuration: const Duration(minutes: 5), restDuration: const Duration(minutes: 3), reps: 2),
          ),
        ];
      } else if (weekNum == 2) {
        days = [
          PlanDay(
            ...
            workout: simpleIntervalWorkout('2 min row, 1 min rest', 'Focus on a powerful drive.', workDuration: const Duration(minutes: 2), restDuration: const Duration(minutes: 1), reps: 5),
          ),
          PlanDay(
            id: 'ii_beg_w2_d2',
            title: 'Session 2: Longer Pieces',
            workout: simpleIntervalWorkout('5 min row, 3 min rest', 'Focus on smooth recovery.', workDuration: const Duration(minutes: 5), restDuration: const Duration(minutes: 3), reps: 3),
          ),
        ];
      } else if (weekNum == 3) {
        days = [
          PlanDay(
            ...
            workout: Workout(
              ...
              stages: [
                ...
                for (int i = 0; i < 4; i++) ...[const WorkoutStage(name: '500m Effort', duration: Duration(minutes: 2, seconds: 30), description: 'Approx duration. Medium intensity.'), const WorkoutStage(name: 'Rest', duration: Duration(minutes: 2), description: 'Paddle lightly.')],
        ...
        days = [
          PlanDay(
            ...
            workout: simpleIntervalWorkout('5 min row, 3 min rest', 'Medium intensity.', workDuration: const Duration(minutes: 5), restDuration: const Duration(minutes: 3), reps: 4),
          ),
          PlanDay(
            id: 'ii_beg_w8_d2',
